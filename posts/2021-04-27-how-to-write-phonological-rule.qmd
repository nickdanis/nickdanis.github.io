...
categories: 
    ...
    - tutorial
date: 2021-04-27
image: /posts/assets/rule-alignment.png
---
...
![Screenshot of rule from Sound Pattern of English page 352.](/posts/assets/spe-rule.png)
...
![Insert brackets for each feature matrix.](/posts/assets/rule-brackets.png)
...
![Change feature names to plain text.](/posts/assets/rule-text.png)
...
<img src="/posts/assets/Rule%20example.gif">
...
![Image of final rule, with the slash and underscore as plain text.](/posts/assets/rule-final.png)
...
![Change column alignment to better match visually the original rule.](/posts/assets/rule-alignment.png)
...
![Save rule template to the Equations gallery.](/posts/assets/rule-save.png)

Now, you can insert the rule with a single click from the Equations gallery accessible from the Equation ribbon.

![Select rule from the Equations gallery for easy insertion next time.](/posts/assets/rule-saved.png)
